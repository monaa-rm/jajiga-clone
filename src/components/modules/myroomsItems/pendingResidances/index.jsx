import PendingResidanceItem from "@/components/elements/getResidances/pending-residance-item";
import Image from "next/image";

const PendingResidances = ({
  data,
  isSearching,
  setIsSearching,
  setActiveItem,
  ...
  return isSearching && !data?.length ? (
    ...
    <div className="px-6 xl:px-28 text-gray-700 pt-6">
      هیچ اقامتگاه در انتظار تاییدی وجود ندارد
    </div>
  ) : null;
};

export default PendingResidances;
