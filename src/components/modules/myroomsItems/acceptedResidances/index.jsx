import AcceptedResidanceItem from "@/components/elements/getResidances/accepted-residance-item";
import Image from "next/image";

const AcceptedResidances = ({
  data,
  isSearching,
  setIsSearching,
  setActiveItem,
  ...
  return isSearching && !data?.length ? (
    ...
    <div className="px-6 xl:px-28 text-gray-700 pt-6">
      هیچ اقامتگاه تایید شده ای وجود ندارد
    </div>
  ) : null;
};

export default AcceptedResidances;
